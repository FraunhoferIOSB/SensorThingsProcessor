# SensorThingsProcessor [![Build Status](https://travis-ci.org/FraunhoferIOSB/SensorThingsProcessor.svg?branch=master)](https://travis-ci.org/hylkevds/SensorThingsProcessor)
